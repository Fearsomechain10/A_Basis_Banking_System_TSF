...
<body>
    ...
    <div id="content-body">
        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="dmitry-demidko-eBWzFKahEaU-unsplash.jpg" class="d-block w-70 h-10" alt="..." id="img1">
                </div>
                <div class="carousel-item">
                    <img src="alexander-mils-lCPhGxs7pww-unsplash.jpg" class="d-block w-70 h-10" alt="..." id="img2">
                </div>
                <div class="carousel-item">
                    <img src="eduardo-soares-utWyPB8_FU8-unsplash.jpg" class="d-block w-70" alt="...">
                </div>
            </div>
        ...
        <div class="page-about">
            <div class="page-about-glass">
                <section>
                    <h1>About</h1>
                </section>

                <section>
                    <p>Moxa Finance Partners (MFP) a Fortune 500 company, is an Indian Multinational, Public Sector
                        Banking and Financial services statutory body headquartered in Mumbai. The rich heritage and
                        legacy of over 200 years, accredits MFP as the most trusted Bank by Indians through generations.

                        MFP, the largest Indian Bank with 1/4th market share, serves over 45 crore customers through its
                        vast network of over 22,000 branches, 62617 ATMs/ADWMs, 71,968 BC outlets, with an undeterred
                        focus on innovation, and customer centricity, which stems from the core values of the Bank -
                        Service, Transparency, Ethics, Politeness and Sustainability.

                        The Bank has successfully diversified businesses through its various subsidiaries i.e MFP
                        General Insurance,MFP  Life Insurance, MFP Mutual Fund, MFP Card, etc. It has spread its
                        presence globally and operates across time zones through 229 offices in 31 foreign countries.

                        Growing with times, MFP continues to redefine banking in India, as it aims to offer responsible
